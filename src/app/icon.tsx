...
// Mimzo glyph rendered as a PNG so legacy/strict browsers that ignore
// SVG favicons still pick something up.
      ...
      >
        <svg width="48" height="48" viewBox="0 0 92.79 92.79">
          <path
            ...
            fill="#41FEAA"
          />
          <rect x="21.79" y="58.08" width="9.53" height="9.53" fill="#FEFEFE" />
        </svg>
      </div>
    ),
    { ...size },
